 ...
 ?>
     ...
     <main>
        ...
        elseif (isset($_GET['signup']) && $_GET['signup'] == "success") {
          ...
          $message = "Dear " . $_GET['uid'] . ",\n\nThank you for signing up on our website!";
          $headers = "From: ajomni4567@gmail.com";
  
          if (mail($to, $subject, $message, $headers)) {
              echo '<div class="alert alert-info" role="alert">Confirmation email sent!</div>';
          } else {
              echo '<div class="alert alert-warning" role="alert">Failed to send confirmation email.</div>';
          }
      }
         ?>
