    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php">EduNXT</a></div>
          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <li><a href="#teachers-section" class="nav-link">Memebers</a></li>
              </ul>
            </nav>
          </div>
      ...
      <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 mb-5 text-center"  data-aos="fade-up" data-aos-delay="">
            <h2 class="section-title">Our Memebers</h2>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="teacher text-center">
              <img src="images/anuj.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Anuj Sisodiya</h3>
                <p class="position">EduNXT Member</p>
                <p>We have created an Easy and Efficient platform to make learning easy</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="teacher text-center">
              <img src="images/yash.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Yash Bansal</h3>
                <p class="position">EduNXT Memeber</p>
                <p>We aim to make studying SIMPLE, EASY and ACCESSIBLE to EVERYONE thus we collected the BEST COURSES .</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="teacher text-center">
              <img src="images/varun.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Varun Jindal</h3>
                <p class="position">EduNXT Memeber</p>
                <p>Leading expert in the domain of WebDEV, created many website over the years.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-md-8 text-center testimony">
            <img src="images/vedanshi.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
            <h3 class="mb-4">Vednashi Rana</h3>
            <blockquote>
              <p>&ldquo; I was struggling with my studies but it all changed when I learned about EduNXT, I'm now a senior software engineer making a 6 figure salary per year.This website is a real game changer. &rdquo;</p>
            </blockquote>
          </div>
        </div>
      </div>
    ...
    <footer class="footer-section bg-white">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <h3>Subscribe</h3>
            <p>Keep yourself up to date and receive all kind of news about EduNXT.</p>
